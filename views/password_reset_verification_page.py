...
class PasswordResetVerificationPage(ctk.CTkFrame):
    """Modern Password reset verification page using CustomTkinter"""
    ...
    def create_widgets(self):
        ...
        ctk.CTkLabel(logo_frame, text="🔐", font=("Segoe UI Emoji", 90), text_color=Colors.DANGER).pack(pady=(0, 15))
        ctk.CTkLabel(logo_frame, text="OPTIFLOW", font=("Segoe UI", 42, "bold"), text_color="white").pack(pady=(0, 5))
        ctk.CTkLabel(logo_frame, text="Password Verification", font=("Segoe UI", 15), text_color=Colors.TEXT_MUTED).pack()
        ...
        # Welcome text
        ctk.CTkLabel(inner_form, text="Reset Verification", font=("Segoe UI", 24, "bold"), text_color="white").pack(anchor=tk.W, pady=(0, 5))
        ...
        # Notice
        notice_frame = ctk.CTkFrame(inner_form, fg_color="#302a1b", corner_radius=5)
        notice_frame.pack(fill=tk.X, pady=(0, 20))
        ctk.CTkLabel(notice_frame, text="⚠️ This code expires in 15 minutes", 
                     font=("Segoe UI", 12), text_color="#c9ad6d").pack(pady=10, padx=10)
        ...
        # Verify button
        self.verify_button = ctk.CTkButton(inner_form, text="Reset Password", command=self.verify_code,
